...
class YUrl {
    ...
    public static function getCurrentTrimPageUrl(array $params = []) {
        ...
        $relate_url = isset($_SERVER['REQUEST_URI']) ? YCore::safe_replace($_SERVER['REQUEST_URI']) : $php_self . (isset($_SERVER['QUERY_STRING']) ? '?' .
    ...
    public static function createBackendUrl($module_name, $controller_name, $action_name, array $params = []) {
        $backend_domain_name = \Yaf\Registry::get('backend_domain_name');
